...
// Upstream reserves roughly 1 TB, which fails on normal Windows developer volumes.
// 65,536 pages (about 256 MiB with 4 KiB pages) is ample for this contract suite.
pub(crate) const DEFAULT_LMDB_PAGES: usize = 65_536;
